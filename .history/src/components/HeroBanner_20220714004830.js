...
const HeroBanner = () => {
 ...
 <Typography style={{fontSize:'22px' ,fontFamily:"Alegreya", lineHeight:"35px"}}>   
   ...
   <Stack>
   <Button  variant="contained" size="small" style={{backgroundcolor:"#FF2625", fontWeight:"600px",fontSize:'20px'}} sx={{opacity:'0.1',display:{lg:'block',xs:'none'}}}>Explore Exercise</Button>
   </Stack>
